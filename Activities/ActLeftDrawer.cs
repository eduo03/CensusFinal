...
{
	public class ActLeftDrawer : FrameLayout
	{
		bool opened;
		int contentOffsetX;
		...
		public ActLeftDrawer (Context context) :
		base (context)
		{
			Initialize ();
		}

		public ActLeftDrawer (Context context, IAttributeSet attrs) :
		base (context, attrs)
		{
			Initialize ();
		}

		public ActLeftDrawer (Context context, IAttributeSet attrs, int defStyle) :
